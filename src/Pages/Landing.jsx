...
import SewedyVideo from "../assets/sewedyVidoe.mp4";
    ...
    <Box sx={{ overflow: "hidden" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            digital age. Students learn the latest programming languages and
            software development techniques, preparing them to become skilled
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            {[
              { count: 50, label: "Capstone projects every year" },
              { count: 250, label: "Students" },
              { count: 3, label: "Accredited Certificates" },
            ].map((item, index) => (
              <Paper
                key={index}
                elevation={3}
      ...
      <Box
        id="special-moments"
        sx={{
          bgcolor: inView ? "#1C1D1F" : "background.default",
      ...
      {/* CTA Section */}
      <Container maxWidth="lg" sx={{ textAlign: "center", mb: { xs: 10, md: 15 } }}>
        <motion.div
